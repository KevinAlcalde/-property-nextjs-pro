        ...
        <div className='bg-[#F0F6FA] dark:bg-[#111929] lg:py-24 py-16'>
            <div className='max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8'>
                ...
                <p className='mb-10 sm:mb-3.75 text-base sm:text-xl text-gray justify-center flex'>
                    Consultá disponibilidad y características de cada unidad.
                </p>
                    ...
                    <table className="w-full text-center text-sm sm:text-lg text-gray">
                        <thead>
                            <tr className='border-b border-border dark:border-dark_border'>
                                ...
                                <th className="py-2 sm:py-4 px-2 text-center">Dorm.</th>
                                <th className="py-2 sm:py-4 px-2 text-center">Baños</th>
                                <th className="py-2 sm:py-4 px-2 text-center">Vista</th>
                                <th className="py-2 sm:py-4 px-2 text-center">Piso</th>
                                <th className="py-2 sm:py-4 px-2 text-center">Terraza</th>
                                <th className="py-2 sm:py-4 px-2 text-center">Plano</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr className='border-b border-border dark:border-dark_border'>
